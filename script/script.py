...
HTC_10_phone = '980x2040+1960+580'
HTC_10_screen = '924x1566+1990+780'
...
Sony_Xperia_XZ_screen = '920x1550+1890+740'


def crop(name, phone, trim):
    os.system('convert %s/script/photo/%s/%s -crop %s +repage -resize 400x %s/source/images/_temp/%s/%s' % (pwd, phone, name, trim, pwd, phone, name))
